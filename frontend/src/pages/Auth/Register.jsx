...
export default function Register() {
  ...
  // Get the page user was trying to access before being redirected to login/register
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-700/50 p-8">
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div className="flex items-start">
              <input type="checkbox" className="w-4 h-4 mt-1 bg-slate-900 border-slate-600 rounded text-blue-500 focus:ring-blue-500" />
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-slate-800/50 text-gray-400">Already have an account?</span>
              </div>
            </div>
